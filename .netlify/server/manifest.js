	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/get-account/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/get-entry-activities/_server.js')
			},
			{
				id: "/api/get-issues",
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/get-issues/_server.js')
			},
			{
				id: "/api/get-issue",
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/get-issue/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/get-memberships/_server.js')
			},
			{
				id: "/api/get-roles",
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/get-roles/_server.js')
			},
			{
				id: "/api/get-statuses",
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/get-statuses/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/get-time-entries/_server.js')
			},
			{
				id: "/api/set-issue",
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/set-issue/_server.js')
			},
			{
				...
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/set-time-entries/_server.js')
			},
			{
				id: "/login",
				pattern: /^\/login\/?$/,
